...
function [feat, pos_samples, labels, weights] =  det_samples2(im, pos,motion_model_patch_size,det_config)

patch = getPatch(im, pos, floor(motion_model_patch_size*10));
